    ...
    <table class="uk-table uk-table-hover uk-table-middle uk-table-divider uk-text-nowrap">
      ...
      <tr>
        <th class="">
          <a href="{/table/fieldList/field[@title='requestTitle']/@sort}">
            ...
            <xsl:call-template name="sortText">
              <xsl:with-param name="field" select="/table/fieldList/field[@title='requestTitle']/@code" />
            </xsl:call-template>
          </a>
        </th>
        <th>
        ...
        <th>
          <a href="{/table/fieldList/field[@title='quotePeriod']/@sort}">
            ...
            <xsl:call-template name="sortText">
              <xsl:with-param name="field" select="/table/fieldList/field[@title='quotePeriod']/@code" />
            </xsl:call-template>
          </a>
        </th>
        <th>
          <a href="{/table/fieldList/field[@title='requestStatus']/@sort}">
            ...
            <xsl:call-template name="sortText">
              <xsl:with-param name="field" select="/table/fieldList/field[@title='requestStatus']/@code" />
            </xsl:call-template>
          </a>
        </th>
      </tr>
     ...
     <tbody>
      <xsl:for-each select="data/record">
        ...
        <tr>
          <td>
            <a href="{/table/cardList/card[@title='page_266429'][@recordId=$id]}" target="_self">
