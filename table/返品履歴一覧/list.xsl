      ...
      <tr>
        ...
        <th>
          <a href="{/table/fieldList/field[@title='returnHistoryID']/@sort}">
            ...
            <xsl:call-template name="sortText">
              <xsl:with-param name="field" select="/table/fieldList/field[@title='returnHistoryID']/@code" />
            </xsl:call-template>
          </a>
        </th>
        <th>
        ...
        <th>
          <a href="{/table/fieldList/field[@title='returnTotalPrice']/@sort}">
            ...
            <xsl:call-template name="sortText">
              <xsl:with-param name="field" select="/table/fieldList/field[@title='returnTotalPrice']/@code" />
            </xsl:call-template>
          </a>
        </th>
        <th class="uk-table-shrink">
