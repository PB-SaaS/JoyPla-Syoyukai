     ...
     <thead>
      <tr>
        ...
        <th>
          <a href="{/table/fieldList/field[@title='orderTime']/@sort}">
            ...
            <xsl:call-template name="sortText">
              <xsl:with-param name="field" select="/table/fieldList/field[@title='orderTime']/@code" />
            </xsl:call-template>
          </a>
        </th>
        <th>
      ...
      <xsl:for-each select="data/record">
        ...
        <tr>
          ...
          <td>
            <a href="{/table/cardList/card[@title='page_263320'][@recordId=$id]}" target="_self" class="uk-button uk-button-primary">
              詳細
            </a>
          </td>
        </tr>
