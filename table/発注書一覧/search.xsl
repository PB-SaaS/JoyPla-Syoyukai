  ...
  <div class="">
    <form method="get" class="uk-form-stacked">
      ...
      <div class="uk-width-3-4@m uk-margin-auto">
        <h3>検索</h3>
        <xsl:apply-templates select="fieldList/usr_orderTime" />
...
<xsl:template match="usr_registrationTime">
  <div class="uk-margin">
    <label class="uk-form-label" for="form-stacked-text">未発注書作成日時</label>
...
<!-- 発注日時 -->
<xsl:template match="usr_orderTime">
  <div class="uk-margin">
...
<!-- 入庫日時 -->
<xsl:template match="usr_receivingTime">
  <div class="uk-margin">
    <label class="uk-form-label" for="form-stacked-text">
      入庫日時
    </label>
...
<xsl:template match="sys_multiSearch">
  <div class="uk-margin">
    ...
    <div class="uk-form-controls">
      ...
      <input type="hidden" name="{option/action/@name}" value="0" />
      <span class="uk-text-meta uk-text-small">対象：発注番号 卸業者名 部署名</span>
    </div>
  </div>
</xsl:template>
...
<xsl:template match="usr_orderStatus">
  <div class="uk-margin">
    ...
    <div class="uk-form-controls">
        ...
        <label class="uk-margin-small-right">
                      <input type="checkbox" class="uk-checkbox" name="{../@name}" value="{@value}">
