      ...
      <xsl:for-each select="data/record">
        ...
        <tr style="height:20;">
          ...
          <td>
            ...
            <a class="uk-button uk-button-primary uk-margin-small uk-button-small" href="{/table/cardList/card[@title='page_266500'][@recordId=$id]}" target="_blank">採用</a> <br />
            <a class="uk-button uk-button-danger uk-margin-small uk-button-small" href="{/table/cardList/card[@title='page_266580'][@recordId=$id]}" target="_blank">不採用</a>
            </xsl:if>
          </td>
          <td>
            <xsl:if test="usr_requestFlg != ''">
