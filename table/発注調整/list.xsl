      ...
      <tr>
        ...
        <th>
          <a href="{/table/fieldList/field[@title='stockQuantity']/@sort}">
            ...
            <xsl:call-template name="sortText">
              <xsl:with-param name="field" select="/table/fieldList/field[@title='stockQuantity']/@code" />
            </xsl:call-template>
          </a>
        </th>
        <th>
          <a href="{/table/fieldList/field[@title='orderWithinCount']/@sort}">
            ...
            <xsl:call-template name="sortText">
              <xsl:with-param name="field" select="/table/fieldList/field[@title='orderWithinCount']/@code" />
            </xsl:call-template>
          </a>
        </th>
        <th>
          <a href="{/table/fieldList/field[@title='planInventoryCnt']/@sort}">
            ...
            <xsl:call-template name="sortText">
              <xsl:with-param name="field" select="/table/fieldList/field[@title='planInventoryCnt']/@code" />
            </xsl:call-template>
          </a><br/>
        ...
        <th>
          <a href="{/table/fieldList/field[@title='constantByDiv']/@sort}">
            ...
            <xsl:call-template name="sortText">
              <xsl:with-param name="field" select="/table/fieldList/field[@title='constantByDiv']/@code" />
            </xsl:call-template>
          </a>
        </th>
        <th>
          <a href="{/table/fieldList/field[@title='requiredOrderNum']/@sort}">
            ...
            <xsl:call-template name="sortText">
              <xsl:with-param name="field" select="/table/fieldList/field[@title='requiredOrderNum']/@code" />
            </xsl:call-template>
          </a><br/>
