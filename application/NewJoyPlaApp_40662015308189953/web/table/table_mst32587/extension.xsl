     ...
     <thead>
      <tr>
        <th>
            ...
            <xsl:call-template name="sortText">
              <xsl:with-param name="field" select="'f002349795'" />
            </xsl:call-template>
          </a>
        </th>
        <th>
            ...
            <xsl:call-template name="sortText">
              <xsl:with-param name="field" select="'f002348896'" />
            </xsl:call-template>
          </a>
        </th>
        <th>
        ...
        <th>
            ...
            <xsl:call-template name="sortText">
              <xsl:with-param name="field" select="'f002349797'" />
            </xsl:call-template>
          </a>
        </th>
        <th class="uk-table-shrink">
            ...
            <xsl:call-template name="sortText">
              <xsl:with-param name="field" select="'f002349798'" />
            </xsl:call-template>
          </a>
        </th>
      ...
      <xsl:for-each select="data/record">
        ...
        <tr>
          ...
          <td>
            <a class="uk-button uk-button-primary" href="{/table/cardList/card[@title='page_265019'][@recordId=$id]}" target="_blank">
              変更
            </a>
          </td>
        </tr>
