      ...
      <thead>
	      <tr>
	        ...
	        <th class='uk-width-small f_02'>
	            ...
	            <xsl:call-template name="sortText">
	              <xsl:with-param name="field" select="'f002349761'" />
	            </xsl:call-template>
	          </a>
	        </th>
	        <th class='uk-width-small f_03'>
	            ...
	            <xsl:call-template name="sortText">
	              <xsl:with-param name="field" select="'f002349762'" />
	            </xsl:call-template>
	          </a>
	        </th>
	        ...
	        <th class='uk-width-small f_13'>
	          <a href="{/table/fieldList/field[@title='price']/@sort}">
	            ...
	            <xsl:call-template name="sortText">
	              <xsl:with-param name="field" select="'f002349770'" />
	            </xsl:call-template>
	          </a>
	        </th>
	        <th class='uk-width-small f_14'>
	          <a href="{/table/fieldList/field[@title='oldPrice']/@sort}">
	            ...
	            <xsl:call-template name="sortText">
	              <xsl:with-param name="field" select="'f002349771'" />
	            </xsl:call-template>
	          </a>
	        </th>
	        ...
	        <th class='uk-width-small f_17'>
	          <a href="{/table/fieldList/field[@title='officialFlag']/@sort}">
	            ...
	            <xsl:call-template name="sortText">
	              <xsl:with-param name="field" select="'f002348843'" />
	            </xsl:call-template>
	          </a>
	        </th>
	        ...
	        <th class='uk-width-small f_21'>
	          <a href="{/table/fieldList/field[@title='notice']/@sort}">
	            ...
	            <xsl:call-template name="sortText">
	              <xsl:with-param name="field" select="'f002349768'" />
	            </xsl:call-template>
	          </a>
	        </th>
	      </tr>
      ...
      <xsl:for-each select="data/record">
        ...
        <tr>
          ...
          <td class="">
            ...
            <a class="uk-button uk-button-link" href="{/table/cardList/card[@title='page_267643'][@recordId=$id]}" target="_self">詳細</a>
</td>
          <td class=" f_01">
