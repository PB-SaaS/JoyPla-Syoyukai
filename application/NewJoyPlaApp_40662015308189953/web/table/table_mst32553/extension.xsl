     ...
     <thead>
      <tr>
        ...
        <th>
            ...
            <xsl:call-template name="sortText">
              <xsl:with-param name="field" select="'f002349789'" />
            </xsl:call-template>
          </a>
        </th>
        <th>
        ...
        <th>
            ...
            <xsl:call-template name="sortText">
              <xsl:with-param name="field" select="'f002349791'" />
            </xsl:call-template>
          </a>
        </th>
        <th>
            ...
            <xsl:call-template name="sortText">
              <xsl:with-param name="field" select="'f002349793'" />
            </xsl:call-template>
          </a>
        </th>
        <th>
            ...
            <xsl:call-template name="sortText">
              <xsl:with-param name="field" select="'f002349788'" />
            </xsl:call-template>
          </a>
        </th>
        <th class="uk-table-shrink">
      ...
      <xsl:for-each select="data/record">
        ...
        <tr>
          ...
          <td>
            <a class="uk-button uk-button-primary" href="{/table/cardList/card[@title='page_264970'][@recordId=$id]}" target="_blank">
              変更
            </a>
          </td>
          <td>
            <button type="button" class="uk-button uk-button-danger" onclick="deleteOroshiUserCheck('{/table/cardList/card[@title='page_162467'][@recordId=$id]}','{usr_loginId}')" target="_blank">
              削除
            </button>
          </td>
        </tr>
