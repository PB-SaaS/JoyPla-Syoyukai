    ...
    <table class="uk-table uk-table-hover uk-table-middle uk-table-divider uk-text-nowrap">
     <thead>
        ...
        <th>
            ...
            <xsl:call-template name="sortText">
              <xsl:with-param name="field" select="'f002349683'" />
            </xsl:call-template>
          </a>
        </th>
        <th>
            ...
            <xsl:call-template name="sortText">
              <xsl:with-param name="field" select="'f002349684'" />
            </xsl:call-template>
          </a>
        </th>
        <th>
            ...
            <xsl:call-template name="sortText">
              <xsl:with-param name="field" select="'f002349685'" />
            </xsl:call-template>
          </a>
        </th>
        <th>
            ...
            <xsl:call-template name="sortText">
              <xsl:with-param name="field" select="'f002349686'" />
            </xsl:call-template>
          </a>
        </th>
        <th>
            ...
            <xsl:call-template name="sortText">
              <xsl:with-param name="field" select="'f002349687'" />
            </xsl:call-template>
          </a>
        </th>
