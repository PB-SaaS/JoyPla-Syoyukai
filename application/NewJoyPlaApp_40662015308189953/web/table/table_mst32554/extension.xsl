      ...
      <tr>
        ...
        <th>
            ...
            <xsl:call-template name="sortText">
              <xsl:with-param name="field" select="'f002349081'" />
            </xsl:call-template>
          </a>
        </th>
        <th>
            ...
            <xsl:call-template name="sortText">
              <xsl:with-param name="field" select="'f002349829'" />
            </xsl:call-template>
          </a>
        </th>
        <th>
        ...
        <th>
            ...
            <xsl:call-template name="sortText">
              <xsl:with-param name="field" select="'f002349831'" />
            </xsl:call-template>
          </a>
        </th>
        <th>
            ...
            <xsl:call-template name="sortText">
              <xsl:with-param name="field" select="'f002349827'" />
            </xsl:call-template>
          </a>
        </th>
        <th class="uk-table-shrink">
