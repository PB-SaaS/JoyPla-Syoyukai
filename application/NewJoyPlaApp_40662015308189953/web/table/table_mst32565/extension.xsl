      ...
      <tr>
        ...
        <th>
          <a href="{/table/fieldList/field[@title='registrationTime']/@sort}">
            ...
            <xsl:call-template name="sortText">
              <xsl:with-param name="field" select="'f002349703'" />
            </xsl:call-template>
          </a>
        </th>
        <th>
          <a href="{/table/fieldList/field[@title='payoutHistoryId']/@sort}">
            ...
            <xsl:call-template name="sortText">
              <xsl:with-param name="field" select="'f002348912'" />
            </xsl:call-template>
          </a>
        </th>
        <th>
          <a href="{/table/fieldList/field[@title='sourceDivision']/@sort}">
            ...
            <xsl:call-template name="sortText">
              <xsl:with-param name="field" select="'f002349706'" />
            </xsl:call-template>
          </a>
        </th>
        <th>
          <a href="{/table/fieldList/field[@title='targetDivision']/@sort}">
            ...
            <xsl:call-template name="sortText">
              <xsl:with-param name="field" select="'f002349708'" />
            </xsl:call-template>
          </a>
        </th>
        <th>
          <a href="{/table/fieldList/field[@title='itemsNumber']/@sort}">
            ...
            <xsl:call-template name="sortText">
              <xsl:with-param name="field" select="'f002349709'" />
            </xsl:call-template>
          </a>
        </th>
        <th>
          <a href="{/table/fieldList/field[@title='totalAmount']/@sort}">
            ...
            <xsl:call-template name="sortText">
              <xsl:with-param name="field" select="'f002349710'" />
            </xsl:call-template>
          </a>
        </th>
