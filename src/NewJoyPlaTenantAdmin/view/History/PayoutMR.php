        ...
        <div class="uk-container uk-container-expand">
            <div class="uk-width-1-1 uk-margin-auto">
                <form class="uk-form-stacked" name="myform" action="<?php echo $api_url; ?>" method="post" onsubmit="return payout_report.submitCheck()">
                                    ...
                                    if ($report['count'] > 0) {
                                        foreach ($report['data'] as $record) {
                                            ...
                                            foreach ($record['unitPrice'] as $unitPrice) {
                                                echo "￥".number_format($unitPrice,2)."<br>";
                                            }
                                            echo "</td>";
                                            echo "<td>";
                                            ...
                                            echo "</td>";
                                            echo "<td>";
                                            foreach ($record['payoutQuantity'] as $key => $payoutQuantity) {
                    ...
                    <input name="Action" value="Payout" type="hidden">
...
class PayoutMR
{
    ...
    listDl()
    {
        ...
        result.unshift(['id', 'inHospitalItemId', 'makerName', 'category', 'itemName', 'itemCode', 'itemStandard', 'price', 'unitPrice', 'quantity', 'payoutQuantity', 'totalAmount', 'adjAmount', 'priceAfterAdj', 'quantityUnit']);
