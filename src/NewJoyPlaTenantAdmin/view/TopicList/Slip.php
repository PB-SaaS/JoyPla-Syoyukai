		        ...
		        <form onsubmit="return false;">
		        	...
		        	<div class="uk-margin">
				        ...
				        <div class="uk-form-controls">
		        			<input type="text" class="uk-input" name="name" value="【システム管理者】%val:@usr:name%" readonly>
				        </div>
				    </div>
		        	<div class="uk-margin">
		...
		regComment: function()
		{
			...
			UIkit.modal.confirm('コメントを投稿します。<br>よろしいですか。').then(function(){
				...
				$.ajax({
		            ...
		            type:"POST",
		            data:{
		            	commentData : JSON.stringify( vm.objectValueToURIencode({"comment":comment,"name":name}) ),
		            	Action : 'comment',
