            ...
            foreach($rowData as $row)
            {
                $insert_data[] = 
                    [
                        ...
                        'category' => $row['data'][2],
                        'itemCode' => $row['data'][3],
                        'itemStandard' => $row['data'][4],
                        'itemJANCode' => $row['data'][5],
                        'makerName' => $row['data'][6],
                        'lotManagement' => $row['data'][7],
                        'officialFlag' => $row['data'][8],
                        'officialprice' => $row['data'][9],
                        'catalogNo' => $row['data'][10],
                        'serialNo' => $row['data'][11],
                        'medicineCategory' => $row['data'][12],
                        'homeCategory' => $row['data'][13],
                        'quantity' => $row['data'][14],
                        'quantityUnit' => $row['data'][15],
                        'itemUnit' => $row['data'][16],
                        'price' => $row['data'][17],
                        'minPrice' => $row['data'][18],
                        'unitPrice' => $row['data'][19],
                        'measuringInst' => $row['data'][20],
                        'notice' => $row['data'][21],
