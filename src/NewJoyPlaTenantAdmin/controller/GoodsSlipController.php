...
class GoodsSlipController extends Controller
{
    ...
    public function index()
    {
        ...
        try {
            ...
            $content = $this->view(
                'NewJoyPlaTenantAdmin/view/GoodsList/Slip',
                [
                    'switch_1' => $switch_1,
                    'switch_2' => $switch_2,
                    'switch_3' => $switch_3,
        ...
        try {
            ...
            if ($step == '2') {
                ...
                if ($hospitalId == '') {
                    ...
                    $count = Hospital::where('hospitalId', $hospitalId)
            ...
            if ($step == '3') {
                ...
                if ($distributorId == '') {
                    ...
                    $count = Distributor::where('hospitalId', $hospitalId)
            ...
            if ($step_check == 1) {
                ...
                $content = $this->view(
                    'NewJoyPlaTenantAdmin/view/PriceReg/Step1',
                    [
            ...
            if ($step_check == 2) {
                ...
                $content = $this->view(
                    'NewJoyPlaTenantAdmin/view/PriceReg/Step2',
                    [
                        'hospital' => $hospital->data->get(0),
                        'distributor' => $distributor->data->all(),
                        'current_distributorId' => $SPIRAL->getParam(
                            'distributorId'
                        ),
                        'error' => $error,
                        'api_url' => $api_url,
    ...
    public function priceAndInHospitalItemReg(): View
    {
        global $SPIRAL;
        try {
            $auth = new Auth();
            ...
            if ($step_check == 1) {
                $hospital = Hospital::where('tenantId', $auth->tenantId)->get();
                $content = $this->view(
                    'NewJoyPlaTenantAdmin/view/PriceAndInHospitalItemReg/Step1',
                    [
                        'hospital' => $hospital->data->all(),
                        'current_hospitalId' => $SPIRAL->getParam('hospitalId'),
                        'error' => $error,
            ...
            if ($step_check == 2) {
                ...
                $content = $this->view(
                    'NewJoyPlaTenantAdmin/view/PriceAndInHospitalItemReg/Step2',
                    [
                        'hospital' => $hospital->data->get(0),
                        'distributor' => $distributor->data->all(),
                        'current_distributorId' => $SPIRAL->getParam(
            ...
            if ($step_check == 3) {
                ...
                $content = $this->view(
                    ...
                    [
                        ...
                        'url' => '/regist/is',
                        'hiddens' => [
                            'SMPFORM' => '%smpform:priceAndInHReg%',
                            'hospitalId' => $hospital->hospitalId,
                            'hospitalName' => $hospital->hospitalName,
                            'distributorId' => $distributor->distributorId,
                            'distributorName' => $distributor->distributorName,
        ...
        try {
            ...
            if ($step == '3') {
                ...
                if ($priceId == '') {
                    ...
                    $count = PriceInfoView::where('priceId', $priceId)
                        ->where('tenantId', $auth->tenantId)
                        ->count();
                    if ($count != 1) {
                        $step_check = 2;
            ...
            if ($step_check == 1) {
                $hospital = Hospital::where('tenantId', $auth->tenantId)->get();
                $content = $this->view(
                    'NewJoyPlaTenantAdmin/view/InHospitalItemReg/Step1',
                    [
                        'hospital' => $hospital->data->all(),
                        'current_hospitalId' => $SPIRAL->getParam('hospitalId'),
                        'error' => $error,
            ...
            if ($step_check == 2) {
                $hospitalId = $SPIRAL->getParam('hospitalId');
                $hospital = Hospital::where('hospitalId', $hospitalId)->get();
                $priceInfoView = PriceInfoView::where(
                    'tenantId',
                    $auth->tenantId
                )
                    ...
                    ->get();
                $content = $this->view(
                    'NewJoyPlaTenantAdmin/view/InHospitalItemReg/Step2',
                    [
                        'hospital' => $hospital->data->get(0),
                ...
                $content = $this->view(
                    ...
                    [
                        ...
                        'hiddens' => [
                            ...
                            'priceMText' =>
                                $priceinfo->distributorName .
                                '：￥' .
                                number_format_jp($priceinfo->price) .
                                '/' .
                                number_format_jp($priceinfo->quantity) .
                                $priceinfo->quantityUnit .
                                '(' .
                                $priceinfo->itemUnit .
                                ')',
                            'makerName' => '%val:usr:makerName%',
...
} elseif ($action === 'priceAndInHospitalItemReg') {
    echo $GoodsSlipController->priceAndInHospitalItemReg()->render();
} else {
