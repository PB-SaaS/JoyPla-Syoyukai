...
class DistributorSlipController extends Controller
{
    ...
    public function index(): View
    {
        ...
        try {
            ...
            $content = $this->view(
                'NewJoyPla/view/DistributorInformationSlip',
                [
                    'user_info' => $user_info,
            ...
            $script = $this->view(
                'NewJoyPla/view/template/parts/TableScript',
                [],
                false
            );
...
EOM;
            ...
            $content = $this->view(
                'NewJoyPla/view/template/parts/IframeContent',
                [
                    ...
                    'hiddens' => [
                        ...
                        'orderMethod' => '%val:usr:orderMethod:id%',
                    ],
                ],
                false
            );
...
} elseif ($action === 'distributorUserReg') {
