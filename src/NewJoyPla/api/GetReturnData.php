...
class GetReturnData{
    ...
    private $database = 'returnDatav2';
    private $column = array('id','makerName','itemName','itemCode','itemStandard','quantity','quantityUnit','itemUnit','itemJANCode','price','returnCount','returnPrice','receivingCount','lotNumber','lotDate');
