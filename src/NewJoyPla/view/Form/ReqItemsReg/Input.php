    ...
    <div class="uk-section uk-section-default uk-preserve-color uk-padding-remove">
        <div class="uk-container uk-container-expand" uk-height-viewport="expand: true">
            <div class="uk-width-2-3@m uk-margin-auto uk-margin-remove-top uk-margin-bottom" id="mainPage">
                ...
                <h1>見積商品追加 - 入力</h1>
                <p class="header_text">
                    <p class="uk-text-danger">※登録できない場合、同一JANコードの商品がすでに採用されている可能性があります。</p>
                </p>
                ...
                <form method="post" action="/regist/Reg2">
                    <div class="smp_tmpl">
                        <dl class="cf">
                            <dt class="title">
                                メーカー <span class="need">必須</span>
                            </dt>
                            <dd class="data ">
                                <input class="input $errorInputColor:makerName$" type="text" name="makerName" value="$makerName$" maxlength="128">
                                <br>
                        ...
                        <dl class="cf">
                            ...
                            <dd class="data ">
                                <select class="$errorInputColor:category$" name="category">
                                    ...
                                    <option value="1" $category:1$>医療材料</option>
                                    <option value="2" $category:2$>薬剤</option>
                                    <option value="3" $category:3$>試薬</option>
                                    <option value="4" $category:4$>日用品</option>
                                    <option value="99" $category:99$>その他</option>
                                </select>
                                <br>
                        ...
                        <dl class="cf">
                            ...
                            <dd class="data ">
                                <input class="input $errorInputColor:itemName$" type="text" name="itemName" value="$itemName$" maxlength="128">
                                <br>
                        ...
                        <dl class="cf">
                            <dt class="title">
                                製品コード <span class="need">必須</span>
                            </dt>
                            <dd class="data ">
                                <input class="input $errorInputColor:itemCode$" type="text" name="itemCode" value="$itemCode$" maxlength="128">
                                <br>
                        ...
                        <dl class="cf">
                            <dt class="title">
                                規格 <span class="need">必須</span>
                            </dt>
                            <dd class="data ">
                                <input class="input $errorInputColor:itemStandard$" type="text" name="itemStandard" value="$itemStandard$" maxlength="128">
                                <br>
                        ...
                        <dl class="cf">
                            ...
                            <dd class="data ">
                                <input class="input $errorInputColor:itemJANCode$" type="text" name="itemJANCode" value="$itemJANCode$" maxlength="128">
                                <br>
                        ...
                        <dl class="cf">
                            ...
                            <dd class="data ">
                                <input class="input $errorInputColor:quantityUnit$" type="text" name="quantityUnit" value="$quantityUnit$" maxlength="32">
                                <br>
                        ...
                        <dl class="cf">
                            ...
                            <dd class="data real">
                                <input class="input $errorInputColor:minPrice$" type="text" name="minPrice" value="$minPrice$" maxlength="20" style="text-align: right;">
                                <br>
                        ...
                        <dl class="cf">
                            ...
                            <dd class="data multi2">
                                <ul class="cf">
                                    <li><label><input class="input" type="checkbox" name="lotManagement" value="1" $lotManagement$><span>はい</span></label></li>
                                </ul>
                        ...
                        <dl class="cf">
                            ...
                            <dd class="data multi2">
                                <ul class="cf">
                                    <li><label><input class="input" type="checkbox" name="officialFlag" value="1" $officialFlag$><span>はい</span></label></li>
                                </ul>
                        ...
                        <dl class="cf">
                            ...
                            <dd class="data real">
                                <input class="input $errorInputColor:officialprice$" type="text" name="officialprice" value="$officialprice$" maxlength="20" style="text-align: right;">
                                <br>
                        ...
                        <dl class="cf">
                            ...
                            <dd class="data real">
                                <input class="input $errorInputColor:officialpriceOld$" type="text" name="officialpriceOld" value="$officialpriceOld$" maxlength="20" style="text-align: right;">
                                <br>
                    ...
                    <!-- HIDDEN_PARAM START -->
                    $form:hidden$<input type="hidden" name="tenantId" value="$tenantId$">
