				...
				<form method="post" action="/regist/Reg2">
					<div class="smp_tmpl">
						...
						<dl class="cf">
							...
							<dd class="data ">
								<textarea class="$errorInputColor:medicineCategory$" name="medicineCategory" rows="4"
						...
						<dl class="cf">
							...
							<dd class="data ">
								<textarea class="$errorInputColor:homeCategory$" name="homeCategory" rows="4"
						...
						<dl class="cf">
							...
							<dd class="data ">
								<input class="input $errorInputColor:measuringInst$" type="text" name="measuringInst"
									value="$measuringInst$" maxlength="128"><br>
										...
										<label>
											<div class="uk-card uk-card-default uk-card-small uk-card-hover">
												<div class="uk-card-body selectPrice" style="cursor: pointer">
													<div class="uk-text-right uk-float-right"><input type="radio"
															class="uk-radio" name="priceId"
													...
													<span>購買価格：￥<script>
														...
														/
														<?= $record->itemUnit ?></span><br>
													<p>特記事項:<br><?= nl2br($record->notice) ?>
													</p>
													<input type="hidden" name="distQuantity"
														value="<?= $record->quantity ?>">
													<input type="hidden" name="distPrice"
														value="<?= $record->price ?>">
												</div>
											</div>
										</label>
					...
					<input type="hidden" name="oldUnitPrice"
						value="<?php echo $oldUnitPrice ?>">
					<!-- HIDDEN_PARAM END -->
