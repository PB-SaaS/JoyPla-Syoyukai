...
<body>
                    ...
                    <div class="smp_tmpl">
                        <dl class="cf">
                            ...
                            <dd class="data multi2">
                                <ul class="cf">
                                    <li>
                                        <label><input class="input" type="checkbox" name="notUsedFlag" value="1"
    ...
    ?>
                        ...
                        <dd class="data ">
                            ...
                            <input class="input $errorInputColor:distributorMCode$" type="text" name="distributorMCode"
                                value="$distributorMCode$" maxlength="128">
                            <br>
                        ...
                        <dl class="cf">
                            ...
                            <dd class="data integer">
                                ...
                                <input class="input $errorInputColor:quantity$" type="text" name="quantity"
                                    value="$quantity$" maxlength="10" style="text-align: right;">
                                <br>
                        ...
                        <dl class="cf">
                            ...
                            <dd class="data ">
                                ...
                                <input class="input $errorInputColor:itemUnit$" type="text" name="itemUnit"
                                    value="$itemUnit$" maxlength="32">
                                <br>
                        ...
                        <dl class="cf">
                            ...
                            <dd class="data real">
                                ...
                                <input class="input $errorInputColor:price$" type="text" name="price" value="$price$"
                        ...
                        <dl class="cf">
                            ...
                            <dd class="data real">
                                ...
                                <input class="input $errorInputColor:unitPrice$" type="text" name="unitPrice"
                                    value="$unitPrice$" maxlength="20" style="text-align: right;">
                                <br>
                                <button type="button" onclick="getUnitPrice()"
                                    class="uk-button uk-button-default">単価を自動計算</button>
                                <script>
                        ...
                        <dl class="cf">
                            ...
                            <dd class="data ">
                                <textarea class="$errorInputColor:notice$" name="notice" rows="4"
                                    wrap="soft">$notice$</textarea><br>
