...
include_once 'NewJoyPla/controller/ReqItemRec.php';
?>
<!DOCTYPE html>
<html>
  <head>
			...
			for(let i = 0 ; i < dataKey.length; i++){
				...
				if(dataKey[i] === 'id'){
				    ...
				    input.onchange  = function () {
						...
						$('#itemUnit_'+object.num).css({"color":"rgb(68, 68, 68)", "background-color":"rgb(255, 204, 153)", "width":"96px"});
				    };
				    ...
				    textarea.onchange  = function () {
				    	...
				    	$('#notice_'+object.num).css({"color":"rgb(68, 68, 68)", "background-color":"rgb(255, 204, 153)"});
				    };
				    ...
				    input.onchange  = function () {
						...
						$('#q_'+object.num).css({"color":"rgb(68, 68, 68)", "background-color":"rgb(255, 204, 153)", "width":"96px"});
				    };
		    ...
		    <div class="uk-container uk-container-expand">
				...
				<div class="uk-margin">
					...
					<div class="" id="tablearea">
						%sf:usr:search14:table:mstfilter%
					</div>
				</div>
			</div>
		</div>
