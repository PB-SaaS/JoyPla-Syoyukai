    ...
    <div class="uk-section uk-section-default uk-preserve-color uk-padding-remove uk-margin-top" id="page_top">
        <div class="uk-container uk-container-expand">
            ...
            <div class="no_print uk-margin">
                ...
                <input class="print_hidden uk-button uk-button-primary" type="button" value="出力" onclick="item_list.export()">
            </div>
                    ...
                    <ul uk-accordion class="uk-background-muted uk-padding-small">
                        <li>
                            ...
                            <div class="uk-accordion-content" hidden>
                                <a class="uk-button uk-button-secondary uk-button-small uk-width-1-1" href="#" onclick="item_list.table_field_selector()">反映</a>
                                <ul class="uk-list uk-list-striped">
                                    ...
                                    <li>
                                        <div class="uk-margin uk-grid-small uk-child-width-auto uk-grid">
                                            <label><input class="uk-checkbox chk_24" type="checkbox"> 償還価格フラグ</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="uk-margin uk-grid-small uk-child-width-auto uk-grid">
                                    ...
                                    <li>
                                        <div class="uk-margin uk-grid-small uk-child-width-auto uk-grid">
                                            <label><input class="uk-checkbox chk_28" type="checkbox"> 測定機器名</label>
                                        </div>
                                    </li>
                                </ul>
                            </div>
...
let item_list = new InHospitalItem();
</script>