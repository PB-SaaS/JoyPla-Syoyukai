    ...
    <div class="uk-section uk-section-default uk-preserve-color uk-padding-remove uk-margin-top" id="page_top">
        <div class="uk-container uk-container-expand">
            <ul class="uk-breadcrumb no_print">
                ...
                <li><a
                        href="<?php echo $link ?>&table_cache=true"><span>棚卸履歴一覧</span></a>
                </li>
                <li><a href="#" onclick="end_inventory_slip.search('%val:usr:inventoryEndId%')"><span>棚卸結果報告</span></a>
                </li>
            ...
            <div class="no_print uk-margin" uk-margin>
                ...
                <?php if($updateSaving) : ?>
                <input class="print_hidden uk-button uk-button-primary" type="button" value="完了する"
                    onclick="end_inventory_slip.updateSaving();return false;" style="text-transform:none;">
                <?php endif ?>
                <?php if($updateTemporarySaving) : ?>
                <input class="print_hidden uk-button uk-button-primary" type="button" value="一時保存に戻す"
                    onclick="end_inventory_slip.updateTemporarySaving();return false;" style="text-transform:none;">
                <?php endif ?>
                <?php if($delete_button_view_flg): ?>
                <input class="print_hidden uk-button uk-button-danger" type="button" value="%val:usr:divisionName% 棚卸取消"
                    onclick="end_inventory_slip.deleteInvForDiv();return false;" style="text-transform:none;">
                <?php endif ?>
                    ...
                    <table class="uk-table uk-width-1-1 uk-width-2-3@m uk-table-divider">
                            ...
                            <td class="uk-text-right">
                                <script>
                                    if ('%val:usr:inventoryHStatus:id%' === '2') {
                                        document.write(
                                            '<span class="uk-label uk-padding-small uk-padding-remove-vertical uk-label-success" >%val:usr:inventoryHStatus%</span>'
                                        );
                                    } else {
                                        document.write(
                                            '<span class="uk-label uk-padding-small uk-padding-remove-vertical uk-label-danger" >%val:usr:inventoryHStatus%</span>'
                                        );
                                    }
                                </script>
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="uk-text-right">￥<script>
                                    price(fixed("%val:usr:totalAmount%"))
                                </script> - </td>
                        </tr>
                    </table>
                </div>
            ...
            <ul class="uk-child-width-expand uk-tab no_print" style="margin-top: 50px!important">
                <li>
                    <a href="%url/card:page_263646%&Action=ItemIndex">商品別</a>
                </li>
                <li class="uk-active">
                    <a href="%url/card:page_204569%&Action=LotIndex">ロット別</a>
                </li>
            </ul>

            <ul class="uk-switcher uk-margin no_print">
                <li class="uk-section-xsmall uk-background-default uk-active">
                    <div class="uk-padding" id="tablearea">
                        <h3>ロット別</h3>
                        <?php echo $table ?>
                    </div>
                </li>
