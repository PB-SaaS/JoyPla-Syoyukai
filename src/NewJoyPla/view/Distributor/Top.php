				    ...
				    <div>
				        <div class="nj_card content-1">
	                        <div class="menu-content">
	                            ...
	                            <a href="%url/rel:mpgt:OrderD%" class="slide1 animsition-link"  data-animsition-out-class="fade-out"></a>
	                        </div>
				        </div>
				    </div>
				    <div>
				        <div class="nj_card content-2">
	                        <div class="menu-content">
	                            ...
	                            <a href="%url/rel:mpgt:OrderD%&Action=acceptanceFormList" class="slide2"></a>
	                        </div>
				        </div>
				    </div>
				    <div>
				        <div class="nj_card content-3">
	                        <div class="menu-content">
	                            ...
	                            <a href="%url/rel:mpgt:Achievement%" class="slide3"></a>
	                        </div>
				        </div>
				    </div>
				    <div>
				        <div class="nj_card content-4">
	                        <div class="menu-content">
	                            ...
	                            <a href="%url/rel:mpgt:TopicD%" class="slide4"></a>
	                        </div>
				        </div>
				    </div>
				    <div>
						...
						<div class="topic">
				    		<div class="title">
				    			<div uk-grid>
					    			...
					    			<p class="uk-width-1-2 uk-text-right">
					    				<a href="%url/rel:mpgt:TopicD%" class="uk-link" style="color:#ffffff">More Info</a>
					    			</p>	
				    			</div>
				    		</div>
				    		<div class="uk-padding-small">
						    ...
						    <div>
						        <div class="nj_card content-7-1">
			                        <div class="menu-content">
			                            ...
			                            <a href="%url/rel:mpgt:ProductQuotation%&Action=Quotation" class="slide1 animsition-link"  data-animsition-out-class="fade-out"></a>
			                        </div>
						        </div>
						    </div>
						</div>
						    ...
						    <div>
						        <div class="nj_card content-7-1">
			                        <div class="menu-content">
			                            ...
			                            <a href="%url/rel:mpgt:ProductQuotation%" class="slide1 animsition-link"  data-animsition-out-class="fade-out"></a>
			                        </div>
						        </div>
						    </div>
						</div>
						        ...
						        <div class="nj_card content-8-1">
			                        <div class="menu-content">
			                            ...
			                            <a href="#" onclick="document.userInfoChange.submit();" class="slide1"></a>
											<form method="post" action="<?php echo $url ?>" name="userInfoChange">
						    ...
						    <div>
						        <div class="nj_card content-8-1">
			                        <div class="menu-content">
			                            <div class="menu-body">
			                                <p>
				                                <span class="title">卸業者情報</span><br>
				                                <span class="text">Distributor Info</span>
			                                </p>
			                            </div>
			                            <div class="menu-foot">
			                                <span>More Info</span>
			                            </div>
			                            <a href="%url/rel:mpgt:DistributorInfo%" class="slide1 animsition-link"  data-animsition-out-class="fade-out"></a>
			                        </div>
						        </div>
						    </div>
						</div>
