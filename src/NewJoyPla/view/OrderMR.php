...
class OrderMR
{
    ...
    listDl()
    {
        ...
        result.unshift(['id', 'inHospitalItemId', 'makerName', 'category', 'itemName', 'itemCode', 'itemStandard','itemJANCode', 'price', 'orderQuantity', 'totalAmount', 'itemUnit', 'distributorName']);
