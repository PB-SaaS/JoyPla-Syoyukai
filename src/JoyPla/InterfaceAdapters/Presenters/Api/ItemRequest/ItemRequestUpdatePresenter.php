...
namespace JoyPla\InterfaceAdapters\Presenters\Api\ItemRequest {
    ...
    class ItemRequestUpdatePresenter implements ItemRequestUpdateOutputPortInterface
    {
        public function output(ItemRequestUpdateOutputData $outputData)
        {
            $viewModel = new ItemRequestUpdateViewModel($outputData);
            echo (new ApiResponse($viewModel->data, $viewModel->count, $viewModel->code, $viewModel->message, ['ItemRequestUpdatePresenter']))->toJson();
        }
    }
    ...
    {
        /**
         * ItemRequestUpdateViewModel constructor.
         * @param ItemRequestUpdateOutputData $source
         */
