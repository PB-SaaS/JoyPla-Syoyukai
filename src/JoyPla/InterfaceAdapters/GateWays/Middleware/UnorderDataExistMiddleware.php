...
class UnorderDataExistMiddleware extends Middleware implements MiddlewareInterface {
    ...
    public function process(array $vars) : void
    {
        ...
        $unOrder = Order::where('hospitalId',$auth->hospitalId)->where('orderStatus',OrderStatus::UnOrdered)->value('id');
