    ...
    <div class="flex-auto">
      <div class="index container mx-auto">
        ...
        <div class="md:grid md:grid-cols-4 md:gap-10 gap-4 my-2">
          ...
          <card-button main-color="bg-ochre-500" text-color="text-ochre-50" sub-color="bg-ochre-600" label-text="会計データ" path="/accountant/items">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" class="stroke-ochre-700" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
            </svg>
          </card-button>
          <card-button main-color="bg-ochre-500" text-color="text-ochre-50" sub-color="bg-ochre-600" label-text="会計変更ログ" path="/accountant/logs">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" class="stroke-ochre-700" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
            </svg>
          </card-button>
