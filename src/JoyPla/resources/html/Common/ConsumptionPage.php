    ...
    <div class="flex-auto">
      <div class="index container mx-auto">
        ...
        <div class="md:grid md:grid-cols-4 md:gap-10 gap-4 my-2">
          <card-button main-color="bg-cornflower-blue-500" text-color="text-cornflower-blue-50" sub-color="bg-cornflower-blue-600" label-text="個別消費" path="/consumption/regist">
