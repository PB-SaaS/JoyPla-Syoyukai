            ...
            <div class="index container mx-auto">
                ...
                <div class="md:grid md:grid-cols-4 md:gap-10 gap-4 my-2">
                    ...
                    <card-button main-color="bg-sushi-500" text-color="text-sushi-50" sub-color="bg-sushi-600"
                        label-text="個別請求" path="/itemrequest/register">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" class="stroke-sushi-300" stroke-linejoin="round"
                    ...
                    <card-button main-color="bg-sushi-500" text-color="text-sushi-50" sub-color="bg-sushi-600"
                        label-text="請求履歴一覧" path="/itemrequest/history">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" class="stroke-sushi-300" stroke-linejoin="round"
                    ...
                    <?php endif ?>
                    <?php if(gate('list_of_item_requests')->can()): ?>
                    <card-button main-color="bg-sushi-500" text-color="text-sushi-50" sub-color="bg-sushi-600"
                        label-text="請求商品一覧" path="/itemrequest/show">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" class="stroke-sushi-300" stroke-linejoin="round"
