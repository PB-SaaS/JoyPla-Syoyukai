                        ...
                        <div class="smp_tmpl">
                            ...
                            <div class="cf mt-4">
                                ...
                                <div class="relative">
                                    ...
                                    <?= $is_error && $val['category']['message']
                                        ? 'text-red-500 border-red-500'
                                        : 'text-gray-700 border-gray-300' ?>" 
                                    >
                                        <option value="">----- 選択してください -----</option>
                                        <option value="1"  <?php echo $val[
                                            'category'
                                        ]['value'] === '1'
                                            ? 'selected'
                                            : ''; ?>>医療材料</option>
                                        <option value="2"  <?php echo $val[
                                            'category'
                                        ]['value'] === '2'
                                            ? 'selected'
                                            : ''; ?>>薬剤</option>
                                        <option value="3"  <?php echo $val[
                                            'category'
                                        ]['value'] === '3'
                                            ? 'selected'
                                            : ''; ?>>試薬</option>
                                        <option value="4"  <?php echo $val[
                                            'category'
                                        ]['value'] === '4'
                                            ? 'selected'
                                            : ''; ?>>日用品</option>
                                        <option value="99" <?php echo $val[
                                            'category'
                                        ]['value'] === '99'
                                            ? 'selected'
                                            : ''; ?>>その他</option>
                            ...
                            <div class="cf mt-4">
                                ...
                                <div class="flex-auto">
                                    ...
                                    <?= $is_error &&
                                    $val['smallCategory']['message']
                                        ? 'text-red-500 border-red-500'
                                        : 'text-gray-700 border-gray-300' ?>" 
                                    value="<?php echo html(
                                        $val['smallCategory']['value']
                                    ); ?>">
                                    <span class="text-red-500"><?php echo html(
                                        $val['smallCategory']['message']
                                    ); ?></span>
                            ...
                            <div class="cf mt-4">
                                ...
                                <div class="flex-auto">
                                    ...
                                    <?= $is_error &&
                                    $val['itemStandard']['message']
                                        ? 'text-red-500 border-red-500'
                                        : 'text-gray-700 border-gray-300' ?>" 
                                    value="<?php echo html(
                                        $val['itemStandard']['value']
                                    ); ?>">
                                    <span class="text-red-500"><?php echo html(
                                        $val['itemStandard']['message']
                                    ); ?></span>
                            ...
                            <div class="cf mt-4">
                                ...
                                <label>
                                    ...
                                    <?= $val['lotManagement']['value']
                                        ? 'checked'
                                        : '' ?> >はい
                                </label><br>
                                <span class="text-red-500"><?php echo html(
                                    $val['lotManagement']['message']
                                ); ?></span>
                            </div>
                            <div class="cf mt-4">
                                <div class="flex-initial lg:w-1/6 w-auto lg:whitespace-pre whitespace-normal">
                                ...
                                <label>
                                    ...
                                    <?= $val['officialFlag']['value']
                                        ? 'checked'
                                        : '' ?> >はい
                                </label><br>
                                <span class="text-red-500"><?php echo html(
                                    $val['officialFlag']['message']
                                ); ?></span>
                            </div>
                            <div class="cf mt-4">
                                <div class="flex-initial lg:w-1/6 w-auto lg:whitespace-pre whitespace-normal">
                                ...
                                <div class="flex-auto">
                                    ...
                                    <?= $is_error &&
                                    $val['officialprice']['message']
                                        ? 'text-red-500 border-red-500'
                                        : 'text-gray-700 border-gray-300' ?>" 
                                    value="<?php echo html(
                                        $val['officialprice']['value']
                                    ); ?>">
                                    <span class="text-red-500"><?php echo html(
                                        $val['officialprice']['message']
                                    ); ?></span>
                            ...
                            <div class="cf mt-4">
                                ...
                                <div class="flex-auto">
                                    ...
                                    <?= $is_error &&
                                    $val['officialpriceOld']['message']
                                        ? 'text-red-500 border-red-500'
                                        : 'text-gray-700 border-gray-300' ?>" 
                                    value="<?php echo html(
                                        $val['officialpriceOld']['value']
                                    ); ?>">
                                    <span class="text-red-500"><?php echo html(
                                        $val['officialpriceOld']['message']
                                    ); ?></span>
                            ...
                            <div class="cf mt-4">
                                ...
                                <div class="flex-auto">
                                    ...
                                    <?= $is_error &&
                                    $val['quantityUnit']['message']
                                        ? 'text-red-500 border-red-500'
                                        : 'text-gray-700 border-gray-300' ?>" 
                                    value="<?php echo html(
                                        $val['quantityUnit']['value']
                                    ); ?>">
                                    <span class="text-red-500"><?php echo html(
                                        $val['quantityUnit']['message']
                                    ); ?></span>
