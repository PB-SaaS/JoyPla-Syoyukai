            ...
            <div class="index container mx-auto mb-96">
                ...
                <div class="p-4 text-base bg-gray-100 border border-gray-400">
                    ...
                    <v-text title="発注ステータス" class="flex w-full gap-6">
                        ...
                        <span
                            class="bg-amber-100 text-amber-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded"
                            v-if="order.orderStatus == 3">
                            {{ order.orderStatusToString}}
                        </span>
                        <span
                            class="bg-orange-100 text-orange-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded"
                        ...
                        <span
                            class="bg-red-100 text-red-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded"
                            v-if="order.orderStatus == 7">
                            {{ order.orderStatusToString}}
                        </span>
                        <span
                            class="bg-zinc-100 text-zinc-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded"
                ...
                <div class="p-4 text-lg font-bold">
                    <div class="flex w-full gap-6">
                        ...
                        <div class="flex-auto">&yen;
                            {{ numberFormat( order.totalAmount) }}</div>
                    </div>
                </div>
                <hr>
                    ...
                    <div class="lg:flex w-full gap-6">
                        ...
                        <div class="flex-auto">
                            ...
                            <div class="w-full mt-3" v-for="(item, idx) in fields" :key="item.key">
                                            ...
                                            <div class="flex-auto lg:w-2/5 w-full">
                                                ...
                                                <div class="md:flex gap-6 ">
                                                    ...
                                                    <div>
                                                        <span
                                                            class="bg-red-100 text-red-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded"
                                                            v-if="item.value.orderItemReceivedStatus == 1">
                                                            {{ item.value.orderItemReceivedStatusToString }}
                                                        </span>
                                                        <span
                                                            class="bg-orange-100 text-orange-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded"
                                                            v-if="item.value.orderItemReceivedStatus == 2">
                                                            {{ item.value.orderItemReceivedStatusToString }}
                                                        </span>
                                                        <span
                                                            class="bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded"
                                                            v-if="item.value.orderItemReceivedStatus == 3">
                                                            {{ item.value.orderItemReceivedStatusToString }}
                                                        </span>
                                                    </div>
                                                </div>
                                ...
                                <div
                                    class="p-4 text-base bg-gray-100 border border-gray-400 my-2"
                                    v-if="item.value.orderItemReceivedStatus != 3">
                                    ...
                                    <div
                                        v-for="(received , ridx) in item.value.receiveds"
                                        class="lg:flex gap-6 mt-2">
                                        <div class="lg:w-1/3">
                                            <v-input
                                        ...
                                        <div class="lg:mt-0 mt-2">
                                            <v-text
                                                ...
                                                @click.native="deleteReceived(idx,ridx)">削除</v-button-danger>
                                        </v-text>
                                    </div>
                                </div>
                                <div class="my-4">
                ...
                .then(async (result) => {
                    try {
                        if (result.isConfirmed) {
                            ...
                            Swal
                                .fire({icon: 'success', title: '入荷登録が完了しました。'})
                                .then((result) => {
                                    location.reload();
                                });
                            return true;
