            ...
            <div class="index container mx-auto mb-96">
                ...
                <form method="post" :action="_ROOT+'&path=received/'+received.receivedId + '/label'" target="labelprint" @submit="handleSubmit">
                    <div class="lg:flex gap-4">
                        <v-select 
                        class="lg:w-1/2"
                        name="labelSetting.printType"
                        :options="[{ label: 'A4用紙印刷', value: 1 },{ label: 'ラベルプリンター印刷', value: 2 }]" 
                        name="labelSetting.printType"
                        title="印刷タイプ" 
                        label="印刷タイプ"
                        ></v-select>
                    ...
                    <div class="my-4">
                        <div class="lg:flex gap-4">
                            <v-input-number
                                class="lg:w-1/2"
                                :rules="{ between: [ 0 , 100000 ] }"
                                name="labelSetting.labelwidth"
                                label="ラベル幅"
                                unit="mm"
                                :step="1"
                                title="ラベル幅"></v-input-number>
                            <v-input-number
                                class="lg:w-1/2"
                                :rules="{ between: [ 0 , 100000 ] }"
                                name="labelSetting.labelmheight"
                                label="ラベルの最小の高さ"
                                unit="mm"
                                :step="1"
                                title="ラベルの最小の高さ"></v-input-number>
                        </div>
                        <div class="lg:flex gap-4">
                            <v-input-number
                                class="lg:w-1/2"
                                :rules="{ between: [ 0 , 100000 ] }"
                                name="labelSetting.barcodeHeight"
                                label="バーコードの高さ"
                                unit="px"
                                :step="1"
                                title="バーコードの高さ"></v-input-number>
                            <div
                                class="w-1/2"></div>
                        </div>
                    </div>
                                                ...
                                                <div class="flex-auto lg:w-2/5 w-full">
                                                    ...
                                                    <div class="p-4 text-base bg-gray-100 border border-gray-400 my-2" v-if="item.value.receivedQuantity > 0">
                                                        <v-input-number
                                                            ...
                                                            :name="`receivedItems[${idx}].printedPages`"
                                                            label="印刷数"
                                                            :unit="枚"
                                                            :step="1"
                                                            change-class-name="inputChange"
                                                            title="印刷数"></v-input-number>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
