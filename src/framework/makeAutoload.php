...
$outputtext .=
    ...
    PHP_EOL;
$outputtext .=
    "require_once('framework/SpiralConnecter/SpiralConnecter.php');" . PHP_EOL;
$outputtext .=
    "require_once('framework/SpiralConnecter/SpiralDB.php');" . PHP_EOL;
$outputtext .=
    "require_once('framework/SpiralConnecter/SpiralManager.php');" . PHP_EOL;
$outputtext .=
    "require_once('framework/SpiralConnecter/SpiralExpressManager.php');" .
    PHP_EOL;
$outputtext .=
    "require_once('framework/SpiralConnecter/Paginator.php');" . PHP_EOL;
$outputtext .=
