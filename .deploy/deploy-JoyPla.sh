...
cd ../
if npx tailwindcss -i ./src/JoyPla/resources/parts/input.css.php -o ./src/JoyPla/resources/parts/output.css.php ; then
    cd -
    log "npx tailwindcss -i ./src/JoyPla/resources/parts/input.css.php -o ./src/JoyPla/resources/parts/output.css.php"
fi

if php makeAutoloadJoyPla.php "../src/${TARGET}/require.php" ;then
