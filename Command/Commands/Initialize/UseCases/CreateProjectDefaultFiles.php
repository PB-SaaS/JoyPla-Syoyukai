...
class CreateProjectDefaultFiles {
    ...
    public static function execute($inputdata)
    {
        ...
        $text = View::forge('Command/Samples/resources/template/base');
        file_put_contents("src/{$projectName}/resources/template/base.php", $text);

        $text = View::forge('Command/Samples/resources/html/welcome');
        file_put_contents("src/{$projectName}/resources/html/welcome.php", $text);
    }
}