...
require_once ('src/NewJoyPla/api/PayoutMonthlyReport.php');

 
class PayoutMonthlyReportTest extends TestCase
{
    private $Spiral;
    ...
    public function testDataSelect()
    {
        ...
        $this->assertEquals($result, $payoutMonthlyReport->dataSelect('2020/01/01','2020/01/01','divisionId','itemName','itemCode','itemStandard','100','10'));
