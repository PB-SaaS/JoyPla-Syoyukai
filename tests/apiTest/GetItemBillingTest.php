...
require_once ('src/NewJoyPla/api/GetItemBilling.php');


class GetItemBillingTest extends TestCase
{
    private $Spiral;
    ...
    public function testSelect()
    {
        ...
        $this->assertEquals($this->returnSuccess, $getItemBilling->getItemBilling('billingNumber'));
        ...
        $this->assertEquals($this->returnError, $getItemBilling->getItemBilling('billingNumber'));
    }
}