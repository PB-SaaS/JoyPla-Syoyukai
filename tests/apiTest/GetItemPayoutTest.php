...
require_once ('src/NewJoyPla/api/GetItemPayout.php');


class GetItemPayoutTest extends TestCase
{
    private $Spiral;
    ...
    public function testSelect()
    {
        ...
        $this->assertEquals($this->returnSuccess, $getItemPayout->getItemPayout('payoutNumber'));
        ...
        $this->assertEquals($this->returnError, $getItemPayout->getItemPayout('payoutNumber'));
    }
}