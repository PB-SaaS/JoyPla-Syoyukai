...
require_once ('src/NewJoyPla/api/GetItemReceipt.php');


class GetItemReceiptTest extends TestCase
{
    private $Spiral;
    ...
    public function testSelect()
    {
        ...
        $this->assertEquals($this->returnSuccess, $getItemReceipt->getItemReceipt('payoutNumber'));
        ...
        $this->assertEquals($this->returnError, $getItemReceipt->getItemReceipt('payoutNumber'));
    }
}