...
require_once ('src/NewJoyPla/api/GetTenantData.php');


class GetTenantDataTest extends TestCase
{
    private $Spiral;
    ...
    public function testSelect()
    {
        ...
        $this->assertEquals($this->returnSuccess, $getTenantData->select('tenantId'));
        ...
        $this->assertEquals($this->returnError, $getTenantData->select('tenantId'));
    }
}