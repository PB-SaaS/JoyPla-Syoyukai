...
require_once ('src/NewJoyPla/api/ReceivingMonthlyReport.php');


class ReceivingMonthlyReportTest extends TestCase
{
    private $Spiral;
    ...
    public function testDataSelect()
    {
        ...
        $this->assertEquals($result, $receivingMonthlyReport->dataSelect('2020/01/01','2020/01/01','distributorId','divisionId','itemName','itemCode','itemStandard','100','10'));
        ...
        $this->assertEquals($result, $receivingMonthlyReport->dataSelect('2020/01/01','2020/01/01','divisionId','itemName','itemCode','itemStandard','100','10'));
