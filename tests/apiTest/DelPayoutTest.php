...
require_once ('src/NewJoyPla/api/DelPayout.php');


class DelPayoutTest extends TestCase
{
    private $Spiral;
    ...
    public function testDelete()
    {
        ...
        $this->assertTrue($delPayout->delete('test','test'));
        ...
        $this->assertFalse($delPayout->delete('test','test'));
    }
}