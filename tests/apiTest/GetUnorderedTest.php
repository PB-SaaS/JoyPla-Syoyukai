...
require_once ('src/NewJoyPla/api/GetUnordered.php');


class GetUnorderedTest extends TestCase
{
    private $Spiral;
    ...
    public function testSelect()
    {
        ...
        $this->assertEquals($this->returnSuccess, $getUnordered->select());
        ...
        $this->assertEquals($this->returnError, $getUnordered->select());
    }
}