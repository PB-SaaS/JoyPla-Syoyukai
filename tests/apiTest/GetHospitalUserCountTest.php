...
require_once ('src/NewJoyPla/api/GetHospitalUserCount.php');


class GetHospitalUserCountTest extends TestCase
{
    private $Spiral;
    ...
    public function testSelect()
    {
        ...
        $getHospitalUserCount = new \App\Api\GetHospitalUserCount($spiralDataBase,$userInfo);

        $this->assertEquals($this->returnSuccess, $getHospitalUserCount->select('hospital_1'));
        ...
        $this->assertEquals($this->returnError, $getHospitalUserCount->select('hospital_1'));
    }
}