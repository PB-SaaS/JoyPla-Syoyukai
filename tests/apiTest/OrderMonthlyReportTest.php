...
require_once ('src/NewJoyPla/api/OrderMonthlyReport.php');


class OrderMonthlyReportTest extends TestCase
{
    private $Spiral;
    ...
    public function testDataSelect()
    {
        ...
        $this->assertEquals($result, $orderMonthlyReport->dataSelect('2020/01/01','2020/01/01','distributorId','divisionId','itemName','itemCode','itemStandard','100','10'));
        ...
        $this->assertEquals($result, $orderMonthlyReport->dataSelect('2020/01/01','2020/01/01','divisionId','itemName','itemCode','itemStandard','100','10'));
