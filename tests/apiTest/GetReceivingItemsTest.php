...
require_once ('src/NewJoyPla/api/GetReceivingItems.php');


class GetReceivingItemsTest extends TestCase
{
    private $Spiral;
    ...
    public function testSelect()
    {
        ...
        $this->assertEquals($this->returnSuccess, $getReceivingItems->select(array('itemsid','itemsid','itemsid')));
        ...
        $this->assertEquals($this->returnError, $getReceivingItems->select(array('itemsid','itemsid','itemsid')));
    }
}