...
require_once ('src/NewJoyPla/api/GetOrderItems.php');
...
class GetOrderItemsTest extends TestCase
{
    ...
    public function testSelect()
    {
        ...
        $getOrderItems = new \App\Api\GetOrderItems($spiralDataBase,$userInfo);

        $this->assertEquals($this->returnSuccess, $getOrderItems->select('orderNumber','field1','field2','field3','field4'));
        ...
        $this->assertEquals($this->returnError, $getOrderItems->select('orderNumber','field1','field2','field3','field4'));
    }
}