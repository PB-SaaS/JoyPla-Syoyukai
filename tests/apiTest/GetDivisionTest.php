...
require_once ('src/NewJoyPla/api/GetDivision.php');
...
class GetDivisionTest extends TestCase
{
    ...
    public function testSelect()
    {
        ...
        $this->assertEquals(array('store' => array() , 'division'=> array(), 'code' => '0'), $getDivision->select('test'));
        ...
        $this->assertEquals($this->returnError, $getDivision->select('test'));
    }
}